...
public class News extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try(SQLiteDatabase db=data.getReadableDatabase()){
            Cursor cursor=db.query("NEWSPAPER",
    ...
    public void onFavoriteClicked(View view) {
        ...
        try(SQLiteDatabase db = data.getWritableDatabase()){
            int row = db.update("NEWSPAPER",drinkValues,"_id=?",new String[]{Integer.toString(drinkId)});
    ...
    public void onClickCart(View view) {
        ...
        Intent intent = new Intent(News.this, ChartActivity.class);
